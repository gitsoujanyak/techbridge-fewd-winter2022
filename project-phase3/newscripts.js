...
class SiteUser {
  constructor(username, psword, employee) {
...
var createInitialUsers = () => {
  ...
  let storeEmployee = new Employee(
      "John Smith",
      30,
      { add: true, update: true, delete: false, list: true },
      1,
      ...
      console.dir(storeEmployee);

  addSiteUser("employee1", "testing1234", mainEmployee);  
  addSiteUser("employee2", "testing1234", secEmployee); 
  addSiteUser("manager1", "testing5678", mainManager);
  addSiteUser("admin", "testingabc1", storeEmployee);
};
